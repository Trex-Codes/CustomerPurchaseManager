...
def Create_email():
    ...
    frame_create_Email.grid(row=0, column=0, pady=(30,0), padx=100)
    ...
    Label_Option_city.grid(row=5, column=1, padx=(5,30), pady=(0,30))
...
def clear_frame():
    for widget in root_tk.winfo_children():
        widget.pack_forget()  # Ocultar cada widget en el fra   cme
...
def on_login():
    ...
    # email_verify = "sdfsdf@gmail.oil.com"
