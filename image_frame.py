...
Login_frame = ctk.CTkFrame(root_tk, width=250, height=180, fg_color="#242424")  # Set background color to make it visible
...
login_button = ctk.CTkButton(Login_frame, text="Login", width=150, fg_color="#5DA1FA")
